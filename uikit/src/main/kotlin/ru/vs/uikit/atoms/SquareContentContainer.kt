...
/**
 * Это специальный контейнер для квадратных карточек. Он отвечает за 2 вещи
 * - правильное измерение карточек в квадрат (делать это в карточках менее логично мне кажется)
 * - правильное их расположение так что бы влазило ровно 2 штуки не зависимо от ширины экрана + расстояние между ними.
 * - край третей карточки виден (как и на макетах). Тут без вариантов так как расстояние между айтемами меньше чем отступ от края карточки
 *
